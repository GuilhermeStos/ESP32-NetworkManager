 ...
 * - Start the OTA (Over-The-Air) update process.
 * - Set the verbose mode flag.
 * - Check if the device is connected to the WiFi network and the MQTT server.
 * - Publish a message to the MQTT server.
 * - Handle the network connection and MQTT communication in the loop function.
 * - Set the cycle time for the device to be online.
 * 
 * @param pin The pin to be used as an indicator of the connection status.
 * @param mac The MAC address of the device.
 * @param clientID The id of the client.
 * @param clientName The name of the client.
 * @param onlineId The name of the client.
 * @param password The password for OTA.
 * @param msgPayload The payload to be sent.
 ...
 * @param firstCycle The first cycle flag.
 * @param deployCycle The deploy cycle flag.
 * @param currentMillis The current time in milliseconds.
 * @param prevTime The previous time the device was online.
 * @param prevCycle The previous cycle time.
 * @param connectionTimer The connection timer.
 * @param onlineCycle The online cycle time.
...
public:
    ...
    /**
     * @brief Gets the payload received from the MQTT server.
     *
     * @return The payload received from the MQTT server.
     */
    char *getPayload()
    {
        return msgPayload;
